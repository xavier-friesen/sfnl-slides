...
| **kleur is vol of hij is er niet** | in de hoofdstijl staat een hue vol — een rijlabel, een chip, een badge, een getal, een letter — en het vlak eronder is wit met een haarlijn in die hue, of navy op alpha 7000 (`proeven/11`, 76/9/15). Een accent op containersterkte is het ingetogen kleurregister en hoort er alleen te staan als de gebruiker daar expliciet om vroeg (`proeven/02`, 80/6/14) | vier pastelpanelen elk in de hue van hun eigen volle label is de bevinding waarop dit register is ingevoerd: de tint wordt dan het grootste gekleurde vlak en de volle hue heeft niets om tegen af te zetten. Meld het deckbreed met de slidenummers, en vraag of de deck ingetogen bedoeld was — is dat zo, dan is het geen bevinding. `qa_tellingen.py` telt de accenttinten per slide, jij ziet op de render hoeveel oppervlak ze pakken |
| **drie gevuldheden** | de deck wisselt van gevuldheid: met kleur als grondtoon (`proeven/11`, 76/15), weinig accent waar geen set categorieën is (`proeven/03`, 92/3), kaal waar de inhoud erom vraagt (`proeven/01`, 94/1) | ligt élke slide in hetzelfde middengrijs, dan is dat de deckbrede bevinding, niet een slidedefect. Let op de andere kant: één gevuldheid over de hele deck is hetzelfde defect, en "er staat nergens veel kleur" is géén bevinding — wel "alle kleur staat verdund" |
